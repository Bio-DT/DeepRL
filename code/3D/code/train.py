...
'''
# index_dir = "/media/estar/98519505-51e9-4e2d-b09d-5a389290bcd9/yh/3D-molecular/DeepICL-master/data/PDBbind/index_general/2020_index.lst"
index_dir = "/media/estar/98519505-51e9-4e2d-b09d-5a389290bcd9/yh/DeepRL/3D/data/PDBbind/index_general/index.lst"
...
def train(model, args, optimizer, data, data_2, train, device=None, scaler=None, name_label_map=None):
    ...
    while True:
        ...
        if args.autocast:
            with amp.autocast():
                try:
                    total_loss_1, vae_loss_1, type_loss_1, dist_loss_1, ssl_loss_1 = model(sample, name_label_map, device)
                    total_loss_2, vae_loss_2, type_loss_2, dist_loss_2, ssl_loss_2 = model(sample_2, name_label_map, device)
