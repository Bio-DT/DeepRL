...
if __name__ == "__main__":
    ...
    parser.add_argument("--result_dir", help="directory for generated molecules", type=str, default="/media/estar/98519505-51e9-4e2d-b09d-5a389290bcd9/yh/3D-molecular/DeepICL-master20240808/DeepICL-master/example/results_dir")
    parser.add_argument("--key_dir", help="directory for keys", type=str, default="/media/estar/98519505-51e9-4e2d-b09d-5a389290bcd9/yh/3D-molecular/DeepICL-master20240808/DeepICL-master/example/test_keys.pkl")
    parser.add_argument("--smi_dir", help="directory for training set smiles", type=str, default="/media/estar/98519505-51e9-4e2d-b09d-5a389290bcd9/yh/3D-molecular/DeepICL-master20240808/DeepICL-master/data/keys/train_smiles.txt")
    parser.add_argument(
        "--filter_level", 
