...
class DeepRL_DTA_model_GAT(torch.nn.Module):
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
                 n_filters=32, embed_dim=128, output_dim=128, dropout=0.2):

        super(DeepRL_DTA_model_GAT, self).__init__()
    ...
    def forward(self, data):
        ...
        embedded_xt_sub = self.embedding_xt(target)
        ...
        xd = self.fc1_xt(xd)
        alpha = 0.5 ##0.3-->ci=0.897568 mes=0.22174
