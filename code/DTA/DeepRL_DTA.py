...
vocab_size = 128 #200 # the Llama 2 tokenizer has 32K tokens
...
#     smiles = 'O=C1c2c(c3c4ccc(O)cc4n(C4OC(CO)C(O)C(O)C4O)c3c3[nH]c4cc(O)ccc4c23)C(=O)N1NC(CO)CO'
#     smiles_words = torch.from_numpy(second_sequence(smiles)).unsqueeze(0)
#     print("=====================",smiles_words)
#     molecule_encoding = Transformer_lar()  #.permute(1, 0, 2)
#     simle_embedding = molecule_encoding(smiles_words)
